    ...
    <div id="wrapper2">
        <form action="" id="form-resign">
            ...
            <div class="form-group1">
                <input type="password" class="form-input" placeholder="Nhập mật khẩu cũ">
                <div id="eye">
                    <i class="bi bi-eye"></i>
                </div>
            </div>
            ...
            <div><a href="#" class="form-submit" style=" width: 105px; padding-left: 104px;"> XÁC NHẬN </a> </div>
            <p>  <a href="../web/account.php" class="form-forgot" style="color: #5296c9;">Quay lại</a></p>
        </form>
    </div>
